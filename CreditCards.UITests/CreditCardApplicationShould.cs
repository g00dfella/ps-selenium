    ...
    public class CreditCardApplicationShould
    {
        ...
        public void BeInitiatedFromHomePage_EasyApplication()
        {
            using (IWebDriver driver = new ChromeDriver())
            {
                ...
                IWebElement applyLink =
                    wait.Until((d) => d.FindElement(By.LinkText("Easy: Apply Now!"))); // Lambda expression, d is for driver that has been passed as a parameter above
                applyLink.Click();
        ...
        public void BeSubmittedWhenValid()
        {
            using (IWebDriver driver = new ChromeDriver())
            {
                ...
                driver.FindElement(By.Id("SubmitApplication")).Click(); // Traditional submit
                //driver.FindElement(By.Id("Single")).Submit(); // Alternative method to submit a form
